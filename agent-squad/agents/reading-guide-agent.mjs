...
export async function runReadingGuideAgent() {
  ...
  try {
    const prompt = `You are an AP English Reading teacher (Mandarin Teacher 视角). Generate a "reading guide" for this article.
...
Output valid JSON only, no markdown fences, with this exact structure:
{
  ...
  "vocabulary_tier_3": [
    { "word": "expedition", "pos": "noun | 探险/考察", "sent": "文中例句", "zh": "中文释义", "tip": "搭配/用法提示" }
  ],
  ...
  "excerptHtml": "2-3 段英文摘录，用 <p class=\\"ep\\">...</p>，4-6 个关键词用 <mark class=\\"vhl\\">word</mark>",
  "grammarSpotlight": [
...
Requirements: scaffolding_questions 至少 3 条；sentence_logic_map 至少 1 条长难句拆解；vocabulary_tier_3 4-6 个词；所有中文字段用中文。`;
