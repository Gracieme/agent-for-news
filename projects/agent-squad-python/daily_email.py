...
3. ...
❓ 导师追问你：
1. 这篇不是“讲了什么”，而是“解决了什么”？
2. 如果没有这篇，领域里缺的到底是什么？
3. 作者最聪明的一步是什么？
4. 这篇最可能被批评的地方是什么？
5. 你最想偷哪一句、哪一段、哪种推进方式？
6. 这篇对你的论文，不是“启发了我”，而是“我能立刻拿来怎么写”？
...
- “导师追问你”必须逐题回答，不要变成口号；答案要逼学生从“懂内容”走向“会判断”
- 不要输出长篇英文原文，不要超过3句引用
- 不要使用“非常厉害”“很高级”这种空话"""
...
def gen_paper_mentor(
    ...
    try:
        ...
        fallback_text = (
            ...
            "3. 最后看作者如何压缩贡献与意义。\n"
            "❓ 导师追问你：\n"
            "1. 这篇不是在讲很多内容，而是在解决一个什么更核心的问题？\n"
            "2. 如果没有这篇，读者会在哪个关键地方继续混乱或继续空白？\n"
            "3. 作者最聪明的一步，是重新定义问题、组织文献，还是设计证据链？\n"
            "4. 这篇最可能被批评的地方是什么？是太大、太散、证据不够，还是边界不清？\n"
            "5. 你最想偷它哪一句、哪一段、哪一种推进方式？\n"
            "6. 你明天写自己的论文时，哪一种写法可以直接拿来用？\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "✍️ 今日练习\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
